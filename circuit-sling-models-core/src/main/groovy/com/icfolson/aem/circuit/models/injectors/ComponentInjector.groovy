...
class ComponentInjector implements Injector {
    ...
    private static final def REQUEST_INJECTABLES = [SlingHttpServletRequest, WCMMode,
                                                    com.day.cq.wcm.api.components.Component, ComponentContext,
                                                    EditContext, Designer]

    private static final def RESOURCE_INJECTABLES = [Resource, ResourceResolver, ValueMap, Node, Session, Page,
                                                     PageManager]
    ...
    private def getValueForRequest(Class clazz, Object adaptable) {
        ...
        if (request) {
            def bindings = request.getAttribute(SlingBindings.name) as SlingBindings
    ...
    private SlingHttpServletRequest getRequest(Object adaptable) {
        def request = null
